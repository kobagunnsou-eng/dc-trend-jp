...
一方で、**需要側にライドスルー義務が課された例は基本的にない**。需要家は「電気を使う側」であって、系統を支える責任は負わないという前提だったからだ。
...
つまり——**あと1〜2年で、データセンターは「系統を支える義務」を負う側に回る可能性が高い**。これは調達要件にも設計要件にも直結する話だ。
...
米国が2027年のNERC基準で需要側ライドスルーを制度化すれば、その考え方は遅かれ早かれ日本にも入ってくる。**先に来るのは費用の話、あとから来るのが責任の話**——この順番を意識しておく価値がある。
...
- **責任の変化**：系統擾乱時に踏みとどまる義務を、需要側も負う方向へ（PJMの検討、2027年のNERC基準）
