...
サーバー基板ごと専用の誘電性液体（絶縁オイル）に浸漬します。液体は循環ポンプで流れ続け、熱交換器（チラー）で冷やされて循環します。
...
[NTTコミュニケーションズ](https://www.ntt.com/business/services/data-center.html)
...
ただし、冷却トラブルの激減は本物です。空冷環境では夏場に「ラック内温度上昇→サーバー過熱→スロットリング→性能低下」という悪循環が起きることがありますが、液浸ではそのリスクがほぼゼロになります。AIトレーニングのような長時間・高負荷ワークロードでは、この安定性は非常に大きな価値があります。
